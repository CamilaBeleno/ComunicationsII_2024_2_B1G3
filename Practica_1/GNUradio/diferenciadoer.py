...
import diferenciadoer_epy_block_1 as epy_block_1  # embedded python block
import sip



class diferenciadoer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "diferenciadoer")
        ...
        self.qtgui_time_sink_x_0_0_1.set_y_axis(-1, 10)
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f((3, 7,14), True, 1, [])
        ...
        self.connect((self.blocks_vector_source_x_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
...
def main(top_block_cls=diferenciadoer, options=None):
