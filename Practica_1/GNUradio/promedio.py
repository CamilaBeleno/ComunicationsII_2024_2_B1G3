...
import promedio_epy_block_0 as epy_block_0  # embedded python block
import sip
...
class promedio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_number_sink_0_1.set_title("Media Cuadratica")
        ...
        self.qtgui_number_sink_0.set_title("Promedio (media)")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1000, 5, 0, 0)
